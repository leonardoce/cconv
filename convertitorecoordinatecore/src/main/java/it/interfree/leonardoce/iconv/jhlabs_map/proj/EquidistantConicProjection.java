 ...
 * and related variables (which were not functional). Only the spherical case is
 * currently supported.
 * 
 */
...
public class EquidistantConicProjection extends ConicProjection {
    ...
    /*
    public Punto2D transform(Punto2D in, Punto2D out) {
    ...
    /*
    public Punto2D inverseTransform(Punto2D in, Punto2D out) {
