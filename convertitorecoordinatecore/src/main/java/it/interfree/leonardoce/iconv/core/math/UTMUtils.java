package it.interfree.leonardoce.iconv.core.math;
...
public class UTMUtils {
    ...
    *
    */
    void MapLatLonToXY (double phi, double lambda, double lambda0, double xy[])
    {
    ...
    *
    */
    void MapXYToLatLon (double x, double y, double lambda0, double philambda[])
    {
