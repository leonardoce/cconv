 ...
 */
package it.interfree.leonardoce.iconv.jhlabs_map;

import it.interfree.leonardoce.iconv.jhlabs_map.proj.*;
import it.interfree.leonardoce.iconv.math.Punto2D;
import it.interfree.leonardoce.iconv.math.Rettangolo2D;
...
public class MapMath {
	...
	public final static Rettangolo2D WORLD_BOUNDS_RAD = new Rettangolo2D(-Math.PI, -Math.PI/2, Math.PI*2, Math.PI);
	public final static Rettangolo2D WORLD_BOUNDS = new Rettangolo2D(-180, -90, 360, 180);
...
/*
	public static void latLongToXYZ(PuntoBidimensionale ll, Point3D xyz) {
	...
	public static void xyzToLatLong(Point3D xyz, PuntoBidimensionale ll) {
...
*/
	...
	public static int intersectSegments(Punto2D aStart, Punto2D aEnd, Punto2D bStart, Punto2D bEnd, Punto2D p) {
	...
	public static double dot(Punto2D a, Punto2D b) {
		return a.x*b.x + a.y*b.y;
	}
	
	public static Punto2D perpendicular(Punto2D a) {
		return new Punto2D(-a.y, a.x);
	}
	
	public static Punto2D add(Punto2D a, Punto2D b) {
		return new Punto2D(a.x+b.x, a.y+b.y);
	}
	
	public static Punto2D subtract(Punto2D a, Punto2D b) {
		return new Punto2D(a.x-b.x, a.y-b.y);
	}
	
	public static Punto2D multiply(Punto2D a, Punto2D b) {
		return new Punto2D(a.x*b.x, a.y*b.y);
	}
	
	public static double cross(Punto2D a, Punto2D b) {
	...
	public static void normalize(Punto2D a) {
		double d = distance(a.x, a.y);
		a.x /= d;
		a.y /= d;
	}
	
	public static void negate(Punto2D a) {
		a.x = -a.x;
		a.y = -a.y;
	}
