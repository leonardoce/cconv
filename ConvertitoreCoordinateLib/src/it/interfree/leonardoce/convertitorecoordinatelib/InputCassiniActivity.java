...
import it.interfree.leonardoce.iconv.appconvs.CassiniToLatLongOrigine;
...
public class InputCassiniActivity extends AppCompatActivity
{
    private EditText editX;
	private EditText editY;
	private EditText editCassiniDescrizione;
	...
	getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    	...
    	setContentView(R.layout.input_cassini);
        ...
        editCassiniDescrizione = (EditText)findViewById(R.id.editCassiniDescrizione);
    ...
    private void onButtonConverti()
    {
		...
		ICoordinateConversion proiezione = new CassiniToLatLongOrigine(this);
		Punto3D origine = new Punto3D(y, x,	0);
		...
		risultato.descrizione_punto = editCassiniDescrizione.getText().toString();
		risultato.tipo_ingresso = "Da Cassini";
